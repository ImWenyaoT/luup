...
**Superseded by [ADR-0009](0009-node-pnpm-runtime.md)**（经 [ADR-0007](0007-bun-1-4-runtime.md)），2026-08-28。
本条曾于 2026-08-12 接受；0007 一度把 Bun 抬为唯一运行时，0009 定版为 Node.js + pnpm。
下文保留为历史决策记录。
